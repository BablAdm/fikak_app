...
# Login: Administrator / the ADMIN_PASSWORD value in .env (generated by setup.sh)
```
...
- `GET /api/auth/me/export` - Export all personal data (GDPR/CCPA data portability)
- `DELETE /api/auth/me` - Delete account and all associated data (right to erasure)
...
# For MinIO, also point the client at the local server:
